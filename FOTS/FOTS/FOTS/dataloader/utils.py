from shapely.geometry import Polygon # Bounding Boxes
import numpy as np # Handling images
import cv2 # Bounding boxes area calculations and making score map
from PIL import Image # Interpolation
import math # Basic trig and arithmetic operations
...
def get_score_geo(img, vertices, labels, scale, length):
    ...
    #print(f"Score map dimensions: {score_map.shape}")
    ...
    for i, vertice in enumerate(vertices):
        ...
        #print(f"Score map dimensions: {score_map.shape[:-1]}")
        ...
        #print("===================")
        #print(d1[index_y, index_x].shape)
